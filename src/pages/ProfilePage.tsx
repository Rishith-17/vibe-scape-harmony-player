    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white pb-20">
      <div className="pt-8 px-6">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold mb-2">rishithkumar454</h2>
          <p className="text-gray-400 mb-6">rishithkumar454@gmail.com</p>
          ...
          <div className="flex gap-4 justify-center">
            ...
            <button className="bg-gradient-to-r from-red-500 to-red-600 px-6 py-3 rounded-full hover:shadow-lg transition-all duration-300">
              Sign Out
            </button>
          </div>
        </div>
